# dataset settings
dataset_type = 'BTSDataset_Det'
data_root = '/home/yuhaiyang/dataset/'
img_norm_cfg = dict(
    mean=[123.675, 116.28, 103.53], std=[58.395, 57.12, 57.375], to_rgb=True)
crop_size = (512, 1024)
train_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(type='LoadAnnotations_BTS', reduce_zero_label=False),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        data_root=data_root,
        # img_dir='./TextSeg_Release/textseg_train/',
        # ann_dir='./TextSeg_Release/semantic_train/',
        # det_dir='./TextSeg_Release/det_res_train_png/',
