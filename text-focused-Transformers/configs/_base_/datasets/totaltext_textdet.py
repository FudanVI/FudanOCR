# dataset settings
dataset_type = 'TotaltextDataset_Det'
data_root = '/home/yuhaiyang/dataset/totaltext'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(type='LoadAnnotations_totaltext', reduce_zero_label=False),
