# dataset settings
dataset_type = 'ICDAR13Dataset_Det'
data_root = '/home/yuhaiyang/dataset/ICDAR2013'
img_norm_cfg = dict(
...
train_pipeline = [
    ...
    dict(type='LoadAnnotations_icdar13', reduce_zero_label=False),
